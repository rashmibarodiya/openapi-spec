...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/todos/:id', ...((0, runtime_1.fetchMiddlewares)(todosController_1.todosController)), ...((0, runtime_1.fetchMiddlewares)(todosController_1.todosController.prototype.getTodo)), function todosController_getTodo(request, response, next) {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.post('/todos', ...((0, runtime_1.fetchMiddlewares)(todosController_1.todosController)), ...((0, runtime_1.fetchMiddlewares)(todosController_1.todosController.prototype.createTodo)), function todosController_createTodo(request, response, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = {
